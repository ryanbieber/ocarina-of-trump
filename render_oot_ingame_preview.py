"""Render the current blend as a tiny OoT/N64-style in-game preview.

Run with:
  blender --background navi_trump_fast64_example.blend --python render_oot_ingame_preview.py
"""
...
scene.render.filepath = "navi_trump_oot_ingame_preview.png"
...
ground_mat = material("OoTPreview_Ground", (0.045, 0.105, 0.065))
bpy.ops.mesh.primitive_plane_add(size=20.0, location=(0.0, 0.0, 0.0))
ground = bpy.context.object
ground.name = "OoTPreview_Ground"
ground.data.materials.append(ground_mat)

add_tree("TreeLeft", -2.7, 2.6, 4.2, (0.025, 0.16, 0.08))
add_tree("TreeRight", 2.8, 3.0, 5.0, (0.02, 0.12, 0.065))
add_tree("TreeFar", -1.8, 4.0, 3.2, (0.015, 0.09, 0.05))

bpy.ops.object.light_add(type="POINT", location=(0.0, -1.0, 2.3))
fairy_light = bpy.context.object
fairy_light.name = "OoTPreview_FairyLight"
...
front.name = "OoTPreview_FrontLight"
